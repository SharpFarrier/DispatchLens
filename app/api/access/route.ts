...
export async function PATCH(request: Request) {
  ...
  const { email, status, can_import, can_plan, can_review, can_picklist, can_eod, can_dispatched, can_returns, can_allorders, can_calllens, can_users, can_recon, can_otdr,
